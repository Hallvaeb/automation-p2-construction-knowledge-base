...
args = [site_length, site_width, site_num_of_buildings, site_all_buildings_identical, building_length, building_width, building_height, building_energy_consumption, building_number_of_storeys, building_all_storeys_identical, spaces]

Controller.recieveFromUser(args)